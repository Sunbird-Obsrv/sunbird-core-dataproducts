...
class TestJobMonitor extends FlatSpec with Matchers with BeforeAndAfterAll {
    ...
    it should "test Job Monitor" in {
        ...
        val startEvent1 = """{"eid":"JOB_START","ets":1584083811927,"ver":"3.0","mid":"3F06143D1F9D9BE419E45EE0299DFCE9","actor":{"id":"","type":"System"},"context":{"channel":"in.ekstep","pdata":{"id":"AnalyticsDataPipeline","ver":"1.0","pid":"UpdateContentRating","model":null},"env":"analytics","sid":null,"did":null,"cdata":null,"rollup":null},"object":null,"edata":{"data":{"config":{"search":{"type":"local","query":null,"queries":[{"bucket":null,"prefix":null,"startDate":null,"endDate":null,"delta":null,"brokerList":null,"topic":null,"windowType":null,"windowDuration":null,"file":"src/test/resources/device-profile/test-data1.log","excludePrefix":null,"datePattern":null,"folder":null,"creationDate":null}],"druidQuery":null},"filters":null,"sort":null,"model":"org.ekstep.analytics.updater.UpdateContentRating","modelParams":null,"output":[{"to":"console","params":{"printEvent":false}}],"parallelization":10,"appName":"TestUpdateContentRating","deviceMapping":false,"exhaustConfig":null,"name":null},"model":"UpdateContentRating"},"message":"Started processing of UpdateContentRating","class":"org.ekstep.analytics.framework.driver.BatchJobDriver","level":"INFO"},"@timestamp":"2020-03-13T07:16:51+00:00"}
                           |""";
        val startMsg1 = JobMonitor.jobStartMsg(JSONUtils.deserialize[V3DerivedEvent](startEvent1))
        startMsg1 should be ("*Job*: `UpdateContentRating` | Status: `Started` | Date: ``")

        val startEvent2 = """{"eid":"JOB_START","ets":1584083811927,"ver":"3.0","mid":"3F06143D1F9D9BE419E45EE0299DFCE9","actor":{"id":"","type":"System"},"context":{"channel":"in.ekstep","pdata":{"id":"AnalyticsDataPipeline","ver":"1.0","pid":"UpdateContentRating","model":null},"env":"analytics","sid":null,"did":null,"cdata":null,"rollup":null},"object":null,"edata":{"message":"Started processing of UpdateContentRating","class":"org.ekstep.analytics.framework.driver.BatchJobDriver","level":"INFO"},"@timestamp":"2020-03-13T07:16:51+00:00"}
                           |""";
        ...
        val endEvent = """{"eid":"JOB_END","ets":1584083817419,"ver":"3.0","mid":"9B964E639CA41FDD3E1E9F23EDF5B6F1","actor":{"id":"","type":"System"},"context":{"channel":"in.ekstep","pdata":{"id":"AnalyticsDataPipeline","ver":"1.0","pid":"UpdateContentRating","model":null},"env":"analytics","sid":null,"did":null,"cdata":null,"rollup":null},"object":null,"edata":{"data":{"model":"UpdateContentRating","inputEvents":3,"timeTaken":5.0,"outputEvents":1},"status":"SUCCESS","message":"UpdateContentRating processing complete","class":"org.ekstep.analytics.framework.driver.BatchJobDriver","level":"INFO"},"@timestamp":"2020-03-13T07:16:57+00:00"}
                         |""";
        val endMsg = JobMonitor.jobEndMsg(JSONUtils.deserialize[V3DerivedEvent](endEvent))
        endMsg should be("*Job*: `UpdateContentRating` | Status: `SUCCESS` | Date: `` | inputEvents: `3` | outputEvents: `1` | timeTaken: `5.0`")
