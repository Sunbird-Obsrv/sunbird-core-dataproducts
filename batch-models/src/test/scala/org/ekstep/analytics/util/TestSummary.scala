...
import org.ekstep.analytics.framework.ReducedV3Event
...
class TestSummary extends SparkSpec {
    ...
    it should "create summary without uid, pdata and edata.type" in {
        ...
        val event = JSONUtils.deserialize[ReducedV3Event](eventStr)
    ...
    it should "create summary and add ASSESS event" in {
        ...
        val assessEvent = JSONUtils.deserialize[ReducedV3Event](assessStr)
        ...
        val endEvent = JSONUtils.deserialize[ReducedV3Event](endStr)
