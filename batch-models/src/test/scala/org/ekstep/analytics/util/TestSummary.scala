...
class TestSummary extends SparkSpec {
    ...
    it should "create summary without uid, pdata and edata.type" in {
        ...
        val event = JSONUtils.deserialize[V3Event](eventStr)
    ...
    it should "create summary and add ASSESS event" in {
        ...
        val assessEvent = JSONUtils.deserialize[V3Event](assessStr)
        ...
        val endEvent = JSONUtils.deserialize[V3Event](endStr)
