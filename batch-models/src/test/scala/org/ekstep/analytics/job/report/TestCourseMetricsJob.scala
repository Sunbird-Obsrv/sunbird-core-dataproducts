...
//    EmbeddedES.getAllDocuments(AppConf.getConfig("course.metrics.es.index.cbatch")+"/_doc").foreach(f => {
//
//      // Console.println(f)
//    })
//
//    EmbeddedES.getAllDocuments(AppConf.getConfig("course.metrics.es.alias")).foreach(f => {
//      //Console.println(f)
//    })
